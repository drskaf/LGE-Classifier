...
# Loading data
(df) = utils.load_lge_images('/Users/ebrahamalskaf/Documents/**LGE_CLASSIFICATION**/LGE_images', patient_df, INPUT_DIM)
print(len(df))
...
weigth_path = "{}_my_model.best.hdf5".format("lge_VA")
...
with open("lge_VA.json", "w") as json_file:
